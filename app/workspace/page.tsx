...
export default async function Page({
  ...
  // does not guarantee this page's reads never start. Verifying before the
  // first query keeps the guard next to the data it protects, and keeps this
  // page safe on its own if it is ever moved out from under that layout.
